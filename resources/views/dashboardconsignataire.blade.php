...
<body class="bg-gray-100 flex">
    ...
    <aside class="w-64 bg-cyan-300 text-black p-6 flex-shrink-0" x-data="{ openColis: false }">
        <h1 class="text-3xl font-bold text-pink-600 mb-8">TransitFlow</h1>
            <nav class="space-y-4">
        <!-- Dashboard -->
            <a href="{{ route('consignataire.dashboard') }}" class="flex items-center gap-3 text-lg font-semibold hover:underline">
    ...
    <main class="flex-1 p-8">
        ...
        <div class="flex justify-between items-center mb-8">
            ...
            <p>Vous êtes connecté en tant que consignataire.</p>
        </div>
